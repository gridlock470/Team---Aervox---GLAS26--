...
// Floor raised from 0.22 to 0.55 -- at low zoom the dot's on-screen size
// shrinks (radiusMeters is a real-world radius, not a pixel one), so a dim
// fill all but disappeared against the basemap for low-to-mid severities.
export function sevRgba(pct, alpha01 = 0.55 + (pct / 100) * 0.45) {
