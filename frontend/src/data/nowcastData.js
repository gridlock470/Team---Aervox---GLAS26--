...
export const DATA = {
  ...
  /* "Now" (index 0) values below were checked against real conditions on
     2026-09-12 and tuned to match; the +2h/+4h/+6h lead times stay the
     original illustrative forecast scenario. Sources: Mumbai — active
     monsoon, patchy rain, 76% humidity (aqi.in); Meghalaya — showers easing
     as the monsoon recedes, ~21°C (accuweather.com); Himachal Pradesh —
     dry and sunny today, 14°C, 50% humidity in Manali, no active rain
     (accuweather.com), contrasting with the real Orange cloudburst alert
     IMD issued for Kullu/Shimla on 2026-08-07; Chennai — overcast and humid
     but low rain chance, 2-26% through the day (latestly.com). */
  konk: {
  ...
  meg: {
    ...
    hazards: {
      ...
      cloudburst: {
        vals: { cherrapunji:[28,77,92,86], mawsynram:[30,80,94,89], shillong:[22,64,79,72], guwahati:[16,50,63,56], silchar:[14,45,58,51] },
        drivers: [
      ...
      flashflood: {
        vals: { cherrapunji:[24,68,83,77], mawsynram:[26,71,86,80], shillong:[18,57,71,64], guwahati:[20,60,75,68], silchar:[21,63,78,71] },
        drivers: [
    ...
    alerts: [
      { sev:'orange', id:'IN-ML-20260912-0742', headline:'Cloudburst risk building as monsoon showers persist, Mawsynram–Cherrapunji windward belt', area:'East Khasi Hills district', window:'11:00–21:00 IST', sent:'07:42 IST' },
      { sev:'yellow', id:'IN-AS-20260912-0705', headline:'Brahmaputra levels elevated but easing, Guwahati bank', area:'Kamrup Metropolitan district', window:'14:00–22:00 IST', sent:'07:05 IST' },
    ],
  },
  hp: {
    ...
    hazards: {
      thunderstorm: {
        vals: { manali:[9,42,52,45], kullu:[8,39,49,43], mandi:[11,44,55,48], shimla:[7,37,46,40], kinnaur:[10,47,58,51] },
        drivers: [
      ...
      cloudburst: {
        vals: { manali:[14,71,87,81], kullu:[13,68,84,78], mandi:[10,58,73,66], shimla:[8,47,60,53], kinnaur:[16,76,91,86] },
        drivers: [
      ...
      flashflood: {
        vals: { manali:[12,77,93,88], kullu:[11,74,90,84], mandi:[9,62,78,71], shimla:[7,49,62,55], kinnaur:[14,80,96,91] },
        drivers: [
    ...
    alerts: [
      { sev:'yellow', id:'IN-HP-20260912-0742', headline:'Dry and sunny now; afternoon cloudburst watch, Kinnaur–Manali headwall', area:'Kullu & Kinnaur districts, upper Beas/Sutlej', window:'13:00–21:00 IST', sent:'07:42 IST' },
      { sev:'yellow', id:'IN-HP-20260912-0722', headline:'Flash flood watch along Beas valley approach roads as afternoon convection builds', area:'Kullu–Manali corridor', window:'14:00–19:00 IST', sent:'07:22 IST' },
    ],
  },
  chn: {
    title: 'Chennai Metro',
    ...
    hazards: {
      thunderstorm: {
        vals: { chennai:[14,43,54,47], tambaram:[12,40,51,44], velachery:[15,46,57,50], avadi:[11,38,48,42], mahabalipuram:[13,42,52,46] },
        drivers: [
      ...
      cloudburst: {
        vals: { chennai:[10,48,61,54], tambaram:[9,44,57,50], velachery:[12,54,68,61], avadi:[8,39,50,44], mahabalipuram:[11,50,64,57] },
        drivers: [
      ...
      flashflood: {
        vals: { chennai:[16,62,77,70], tambaram:[14,55,69,62], velachery:[20,73,89,83], avadi:[12,47,60,53], mahabalipuram:[11,44,56,49] },
        drivers: [
    ...
    alerts: [
      { sev:'yellow', id:'IN-TN-20260912-0742', headline:'Overcast and humid, low rain chance today; Pallikaranai–Velachery flood watch stays active', area:'Chennai South & Tambaram', window:'15:00–23:00 IST', sent:'07:42 IST' },
      { sev:'yellow', id:'IN-TN-20260912-0710', headline:'Isolated thunderstorm cells possible off Bay of Bengal coast', area:'Mahabalipuram–ECR corridor', window:'14:00–18:00 IST', sent:'07:10 IST' },
    ],
  },
};
