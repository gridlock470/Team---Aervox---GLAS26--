...
async function encode(data, options = {}) {
  const { draco } = await loadDracoEncoderModule((0, import_worker_utils2.extractLoadLibraryOptions)(options));
...
async function parse(arrayBuffer, options) {
  var _a;
  const { draco } = await loadDracoDecoderModule((0, import_worker_utils3.extractLoadLibraryOptions)(options), ((_a = options == null ? void 0 : options.draco) == null ? void 0 : _a.decoderType) || "wasm");
