...
function parseQuantizedMesh(arrayBuffer, options = {}) {
  ...
  const boundingBox = (0, import_schema_utils.getMeshBoundingBox)(attributes);
...
function makeTerrainMeshFromImage(terrainImage, terrainOptions) {
  ...
  const boundingBox = (0, import_schema_utils2.getMeshBoundingBox)(attributes);
...
async function parseTerrain(arrayBuffer, options, context) {
  const loadImageOptions = {
    ...options,
    core: { ...options == null ? void 0 : options.core, mimeType: "application/x.image" },
