...
type GLTFExtensionPlugin = {
    ...
    preprocess?: (gltfData: {
        json: GLTF;
    }, options: GLTFLoaderOptions, context: any) => void | Promise<void>;
    decode?: (gltfData: {
        json: GLTF;
        buffers: {
...
export declare function preprocessExtensions(gltf: any, options?: GLTFLoaderOptions, context?: any): Promise<void>;
