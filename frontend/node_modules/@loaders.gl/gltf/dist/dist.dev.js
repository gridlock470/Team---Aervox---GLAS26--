...
var __exports__ = (() => {
  ...
  var MeshoptDecoder = function() {
    ...
    function initWorkers(count) {
      var source = "self.ready = WebAssembly.instantiate(new Uint8Array([" + new Uint8Array(wasm) + "]), {}).then(function(result) { result.instance.exports.__wasm_call_ctors(); return result.instance; });self.onmessage = " + workerProcess.name + ";" + decode11.toString() + workerProcess.toString();
  ...
  // src/lib/extensions/meshopt-compression.ts
  ...
  // src/lib/extensions/KHR_meshopt_compression.ts
  ...
  // src/lib/extensions/EXT_texture_avif.ts
  ...
  function getTransformKey(sourceTexCoord, extension) {
    const { offset = [0, 0], rotation = 0, scale: scale2 = [1, 1] } = extension;
    return JSON.stringify([sourceTexCoord, offset, rotation, scale2]);
  }
  ...
  function getPrimitiveVertexCount(primitive) {
    ...
    assert3(attribute, "glTF primitive must define at least one attribute");
